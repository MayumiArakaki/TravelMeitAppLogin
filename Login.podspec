...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mayumi/Login'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mayumi' => 'mayumi.arakakisiccha@gmail.com' }
  s.source           = { :git => 'https://github.com/Mayumi/Login.git', :tag => s.version.to_s }
  ...
  s.resource_bundles = {
         'LoginResources' => ['Login/Classes/View/Login.storyboard']
    }
end
